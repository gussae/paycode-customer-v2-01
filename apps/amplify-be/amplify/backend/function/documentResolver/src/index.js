...
var require_dist_cjs8 = __commonJS({
  "../../../../node_modules/@smithy/node-config-provider/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_shared_ini_file_loader = require_dist_cjs6();
...
var require_dist_cjs10 = __commonJS({
  "../../../../node_modules/@smithy/url-parser/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports2);
    var import_querystring_parser = require_dist_cjs9();
...
var require_dist_cjs11 = __commonJS({
  "../../../../node_modules/@smithy/credential-provider-imds/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_node_config_provider = require_dist_cjs8();
    var import_url_parser = require_dist_cjs10();
...
var require_dist_cjs18 = __commonJS({
  "../../../../node_modules/@smithy/smithy-client/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_middleware_stack = require_dist_cjs15();
...
var require_dist_cjs23 = __commonJS({
  "../../../../node_modules/@aws-sdk/middleware-recursion-detection/dist-cjs/index.js"(exports2, module2) {
    ...
    var recursionDetectionMiddleware = /* @__PURE__ */ __name((options) => (next) => async (args) => {
      const { request } = args;
      if (!import_protocol_http2.HttpRequest.isInstance(request) || options.runtime !== "node" || request.headers.hasOwnProperty(TRACE_ID_HEADER_NAME)) {
        return next(args);
      }
...
var require_dist_cjs26 = __commonJS({
  "../../../../node_modules/@aws-sdk/middleware-user-agent/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_util_endpoints = require_dist_cjs25();
    var import_protocol_http2 = require_dist_cjs2();
...
var require_dist_cjs29 = __commonJS({
  "../../../../node_modules/@smithy/config-resolver/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_util_middleware = require_dist_cjs28();
...
var require_getEndpointUrlConfig = __commonJS({
  "../../../../node_modules/@smithy/middleware-endpoint/dist-cjs/adaptors/getEndpointUrlConfig.js"(exports2) {
    ...
    var shared_ini_file_loader_1 = require_dist_cjs6();
...
var require_getEndpointFromConfig = __commonJS({
  "../../../../node_modules/@smithy/middleware-endpoint/dist-cjs/adaptors/getEndpointFromConfig.js"(exports2) {
    ...
    var node_config_provider_1 = require_dist_cjs8();
...
var require_dist_cjs31 = __commonJS({
  "../../../../node_modules/@smithy/middleware-endpoint/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_middleware_serde = require_dist_cjs30();
...
var require_dist_cjs33 = __commonJS({
  "../../../../node_modules/@smithy/util-retry/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_service_error_classification = require_dist_cjs32();
...
var require_dist_cjs34 = __commonJS({
  "../../../../node_modules/@smithy/middleware-retry/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_util_retry = require_dist_cjs33();
    ...
    var import_smithy_client = require_dist_cjs18();
    ...
    var retryMiddleware = /* @__PURE__ */ __name((options) => (next, context) => async (args) => {
      ...
      if (isRetryStrategyV2(retryStrategy)) {
        ...
        const { request } = args;
        const isRequest = import_protocol_http2.HttpRequest.isInstance(request);
        if (isRequest) {
          request.headers[import_util_retry.INVOCATION_ID_HEADER] = (0, import_uuid.v4)();
        }
        while (true) {
...
var require_dist_cjs35 = __commonJS({
  "../../../../node_modules/@smithy/core/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_middleware_endpoint = require_dist_cjs31();
...
var require_convertToBuffer2 = __commonJS({
  "../../../../node_modules/@aws-crypto/crc32/node_modules/@aws-crypto/util/build/convertToBuffer.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.convertToBuffer = void 0;
    var util_utf8_browser_1 = require_dist_cjs37();
    var fromUtf8 = typeof Buffer !== "undefined" && Buffer.from ? function(input) {
      return Buffer.from(input, "utf8");
...
var require_dist_cjs39 = __commonJS({
  "../../../../node_modules/@smithy/eventstream-codec/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_util_hex_encoding = require_dist_cjs38();
...
var require_dist_cjs40 = __commonJS({
  "../../../../node_modules/@smithy/signature-v4/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports2);
    var import_eventstream_codec = require_dist_cjs39();
    var import_util_middleware = require_dist_cjs28();
...
More information can be found at: https://a.co/dzr2AJd`
    ...
    var getDateHeader = /* @__PURE__ */ __name((response) => {
      var _a, _b;
      return import_protocol_http2.HttpResponse.isInstance(response) ? ((_a = response.headers) == null ? void 0 : _a.date) ?? ((_b = response.headers) == null ? void 0 : _b.Date) : void 0;
    }, "getDateHeader");
...
var require_httpAuthSchemeProvider = __commonJS({
  "../../../../node_modules/@aws-sdk/client-sso/dist-cjs/auth/httpAuthSchemeProvider.js"(exports2) {
    ...
    var util_middleware_1 = require_dist_cjs28();
...
var require_runtimeConfig_shared = __commonJS({
  "../../../../node_modules/@aws-sdk/client-sso/dist-cjs/runtimeConfig.shared.js"(exports2) {
    ...
    var smithy_client_1 = require_dist_cjs18();
    var url_parser_1 = require_dist_cjs10();
...
var require_dist_cjs45 = __commonJS({
  "../../../../node_modules/@smithy/util-defaults-mode-node/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports2);
    var import_config_resolver = require_dist_cjs29();
    var import_node_config_provider = require_dist_cjs8();
    var import_property_provider = require_dist_cjs7();
    ...
    var inferPhysicalRegion = /* @__PURE__ */ __name(async () => {
      ...
      if (!process.env[ENV_IMDS_DISABLED]) {
        try {
          const { getInstanceMetadataEndpoint, httpRequest } = await Promise.resolve().then(() => __toESM2(require_dist_cjs11()));
          const endpoint = await getInstanceMetadataEndpoint();
  ...
  "../../../../node_modules/@aws-sdk/client-sso/dist-cjs/index.js"(exports2, module2) {
    ...
    var resolveRuntimeExtensions = /* @__PURE__ */ __name((runtimeConfig, extensions) => {
      const extensionConfiguration = {
        ...
        ...asPartial((0, import_protocol_http2.getHttpHandlerExtensionConfiguration)(runtimeConfig)),
      ...
      return {
        ...
        ...(0, import_protocol_http2.resolveHttpHandlerRuntimeConfig)(extensionConfiguration),
    ...
    var import_core2 = require_dist_cjs41();
...
var require_credentialDefaultProvider = __commonJS({
  "../../../../node_modules/@aws-sdk/client-sso-oidc/dist-cjs/credentialDefaultProvider.js"(exports2) {
    ...
    exports2.defaultProvider = (input) => {
      return () => Promise.resolve().then(() => __importStar3(require_dist_cjs55())).then(({ defaultProvider: defaultProvider2 }) => defaultProvider2(input)());
    };
  }
});
...
var require_STSClient = __commonJS({
  "../../../../node_modules/@aws-sdk/client-sts/dist-cjs/STSClient.js"(exports2) {
    ...
    var middleware_endpoint_1 = require_dist_cjs31();
    var middleware_retry_1 = require_dist_cjs34();
    var smithy_client_1 = require_dist_cjs18();
...
var require_dist_cjs51 = __commonJS({
  "../../../../node_modules/@aws-sdk/client-sts/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_core = require_dist_cjs41();
    var import_protocol_http2 = require_dist_cjs2();
  ...
  "../../../../node_modules/@aws-sdk/credential-provider-ini/dist-cjs/index.js"(exports2, module2) {
    ...
    var resolveCredentialSource = /* @__PURE__ */ __name((credentialSource, profileName) => {
      const sourceProvidersMap = {
        EcsContainer: (options) => Promise.resolve().then(() => __toESM2(require_dist_cjs11())).then(({ fromContainerMetadata }) => fromContainerMetadata(options)),
        Ec2InstanceMetadata: (options) => Promise.resolve().then(() => __toESM2(require_dist_cjs11())).then(({ fromInstanceMetadata }) => fromInstanceMetadata(options)),
        Environment: (options) => Promise.resolve().then(() => __toESM2(require_dist_cjs20())).then(({ fromEnv }) => fromEnv(options))
      };
...
var require_dist_cjs55 = __commonJS({
  "../../../../node_modules/@aws-sdk/credential-provider-node/dist-cjs/index.js"(exports2, module2) {
    ...
    var remoteProvider = /* @__PURE__ */ __name(async (init) => {
      var _a, _b;
      const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await Promise.resolve().then(() => __toESM2(require_dist_cjs11()));
      if (process.env[ENV_CMDS_RELATIVE_URI] || process.env[ENV_CMDS_FULL_URI]) {
        (_a = init.logger) == null ? void 0 : _a.debug("@aws-sdk/credential-provider-node", "remoteProvider::fromHttp/fromContainerMetadata");
        const { fromHttp } = await Promise.resolve().then(() => __toESM2(require_dist_cjs19()));
    ...
    var defaultProvider2 = /* @__PURE__ */ __name((init = {}) => (0, import_property_provider.memoize)(
      (0, import_property_provider.chain)(
        ...init.profile || process.env[import_shared_ini_file_loader.ENV_PROFILE] ? [] : [
          async () => {
            ...
            const { fromEnv } = await Promise.resolve().then(() => __toESM2(require_dist_cjs20()));
            return fromEnv(init)();
          }
        ],
        async () => {
...
var import_credential_provider_node = __toESM(require_dist_cjs55(), 1);
var import_signature_v4 = __toESM(require_dist_cjs40(), 1);
var import_s3_request_presigner = require("@aws-sdk/s3-request-presigner");
var import_client_s3 = require("@aws-sdk/client-s3");
var getSignedUrl = async (params) => {
  const s3Client = new import_client_s3.S3Client({ region: process.env.REGION });
  let command;
  if (params.method === "getObject") {
    command = new import_client_s3.GetObjectCommand({ Bucket: params.bucket, Key: params.key });
  } else {
    ...
    const commandInput = {
      ...
      ContentType: metadataHeaders["Content-Type"] || metadataHeaders["content-type"] || metadataHeaders["x-amz-meta-type"]
    };
    command = new import_client_s3.PutObjectCommand(commandInput);
  }
...
var isValidDocumentMetadata = (metadata) => {
  return typeof metadata.username === "string" && typeof metadata.filename === "string" && typeof metadata.extension === "string" && typeof metadata.partition === "string" && typeof metadata.size === "number" && typeof metadata.type === "string" && (typeof metadata.version === "string" || metadata.version === void 0) && (typeof metadata.ttl === "number" || metadata.ttl === null || metadata.ttl === void 0);
};
...
var getValidatedS3ObjectKey = async (args, tableName) => {
  ...
  const { Item } = await ddbDocClient.send(new import_lib_dynamodb.GetCommand({
    TableName: tableName,
    Key: { key },
    ProjectionExpression: "username, partition, filename, status"
  }));
  if (Item) {
    const isExpectedDocument = Item.username === args.username && Item.partition === args.partition && Item.filename === args.filename;
...
var createS3ObjectKey = (args) => {
  return `${args.username}/${args.partition}/${args.filename}`;
};

// src/resolver.ts
if (!process.env.STORAGE_DOCUMENTSTORE_BUCKETNAME || !process.env.API_PAYCODEGQL_DOCUMENTTABLE_NAME) {
  throw new Error(
    "Missing environment variable for document store bucket name or document table name."
  );
}
var BUCKET = process.env.STORAGE_DOCUMENTSTORE_BUCKETNAME;
var TABLE = process.env.API_PAYCODEGQL_DOCUMENTTABLE_NAME;
var DOWNLOAD_SIGN_URL_EXPIRY = Number(
  process.env.DOWNLOAD_SIGN_URL_EXPIRY || 300
);
var UPLOAD_SIGN_URL_EXPIRY = Number(
  process.env.UPLOAD_SIGN_URL_EXPIRY || 300
);
var downloadDocument = async (args) => {
...
var uploadDocument = async (args) => {
  ...
  const signedUrl = await getSignedUrl({
    ...
    metadataHeaders: createMetadata(args, "headers")
  });
  return {
    statusCode: 200,
    //@ts-ignore
...
var handler = async (event) => {
  ...
  switch (event.info.fieldName) {
    case "uploadDocument":
      return uploadDocument(event.arguments);
    case "downloadDocument":
      return downloadDocument(event.arguments);
    default:
      return {
        statusCode: 400,
